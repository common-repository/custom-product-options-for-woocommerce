<?php
/**
 * Represents a meta box for Field Group Settings
 ...
 */
class Meta_Box_Field_Group_Settings {
    ...
    public function init() {
        ...
        add_meta_box(
            'jempa-field-group-settings-meta-box',
            __("Field Group Settings", JEMPA_DOMAIN),
